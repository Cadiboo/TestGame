...
public final class FluidColorHandler {
	...
	public static void addColor(FluidSupplier<Fluid> supplier, int r, int g, int b) {
		addColor(supplier, 0xFF, r, g, b);
	}

	public static void addColor(FluidSupplier<Fluid> supplier, int a, int r, int g, int b) {
		a = a & 0xFF;
		r = r & 0xFF;
		g = g & 0xFF;
		b = b & 0xFF;
	...
	public static void addColor(FluidSupplier<Fluid> supplier, int color) {
